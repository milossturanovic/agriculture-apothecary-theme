        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-5 pt-lg-0">
                <div class="single-product-content">
                    ...
                    <p>Ako želite da saznate više informacija o našem proizvodu, imate bilo kakva pitanja, ili želite da izvršite narudžbu, slobodno nas kontaktirajte putem e-maila <b><a href="mailto:agan@gmail.com">agan@gmail.com</a></b>. Naš tim za podršku rado će vam pomoći i pružiti sve potrebne informacije.</p>
                    ...
                    <ul class="quantity-with-btn">
                        ...
                        <li class="add-to-cart">
                            <a class="btn btn-pronia-primary px-3" href="/kontakt">Kontaktirajte nas</a>
                        </li>
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-pane fade" id="information" role="tabpanel" aria-labelledby="information-tab">
                    <div class="product-information-body">
                        <?php the_field('product_tabs_product_information'); ?>
                    </div>
                </div>
